...
namespace Petrivske.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Delete(string Id)
        {
            ...
            var curUser = db.Users.Find(Id);
            curUser.IsDelete = true;
            db.SaveChanges();
        ...
        public ActionResult Edit(string id)
        {
            if (id == null)
                return HttpNotFound();
            var curUser = UserManager.FindById(id);
            if (curUser == null)
                return HttpNotFound();

            EditViewModel ed = new EditViewModel();
            ed.Id = curUser.Id;
            ed.Name = curUser.Name;
            ed.Email = curUser.Email;
            return View(ed);
        }
        ...
        public ActionResult Edit(EditViewModel model)
        {
            ...
            {
                ApplicationDbContext db = new ApplicationDbContext();
                var curUser = db.Users.Find(model.Id);
